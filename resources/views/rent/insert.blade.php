...
<div class="container">
	...
	<form method="post" action="{{ url('/rent/insert') }}">
	@csrf
					    ...
					    <div class="col-sm-8">
					      <select name="customer_id" id="customer_id" class="form-select form-select-sm ft-13" required>
				            ...
				            @foreach($option_customers as $customers)
				              <option value="{{ $customers->id }}">{{ $customers->customer_title }}</option>
				            @endforeach
				          </select>
				          @error('is_available')
			...
			<div class="row">
				<div class="col-md-6">
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-8">
					    	<input type="text" name="start_date" id="start_date" class="form-control form-control-sm" placeholder="dd-mm-yyyy" value="" autocomplete="off" required="" style="width: 30%;" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-8">
					    	<input type="text" name="end_date" id="end_date" class="form-control form-control-sm" placeholder="dd-mm-yyyy" value="" autocomplete="off" required="" style="width: 30%;" />
					    </div>
					</div>
				</div><!-- /.col-md-6 -->
			...
			<div class="row">
				<div class="col-md-6">
					    ...
					    <div class="col-sm-8">
					      <select name="car_id" id="car_id" class="form-select form-select-sm ft-13" required>
				            ...
				            @foreach($option_cars as $cars)
				              <option value="{{ $cars->id }}" data-price="{!! $cars->car_rent_price !!}">{{ $cars->car_title }}</option>
				            @endforeach
				          </select>
				          @error('is_available')
				            <div class="alert alert-danger">{{ $message }}</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-3">
					    	<input type="text" name="available_status" id="available_status" class="form-control form-control-sm" placeholder="OK/NOT OK" readonly="" value="" autocomplete="off" required="" />
					    </div>
					</div>
				</div><!-- /.col-md-6 -->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-8">
					    	<input type="text" name="date_of_return" id="date_of_return" class="form-control form-control-sm" placeholder="dd-mm-yyyy" value="" autocomplete="off" style="width: 30%;" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-3">
					    	<input type="text" name="days_no" id="days_no" class="form-control form-control-sm" placeholder="0" value="" autocomplete="off" readonly="" required="" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-3">
					    	<input type="text" name="extends_day" id="extends_day" class="form-control form-control-sm" placeholder="0" value="0" readonly="" autocomplete="off" required="" />
					    </div>
					</div>
				</div><!-- /.col-md-6 -->
				...
				<div class="col-md-6">
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-5">
					    	<input type="text" name="car_rent_price" id="car_rent_price" class="form-control form-control-sm" placeholder="0" value="0" readonly="" autocomplete="off" required="" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-5">
					    	<input type="text" name="total_price" id="total_price" class="form-control form-control-sm" placeholder="0" value="0" readonly="" autocomplete="off" required="" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-5">
					    	<input type="text" name="dp_paid" id="dp_paid" class="form-control form-control-sm calc" placeholder="0" value="0" autocomplete="off" required="" />
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-5">
					    	<input type="text" name="grand_total" id="grand_total" class="form-control form-control-sm" placeholder="0" value="0" readonly="" autocomplete="off" required="" />
					    </div>
					</div>
				</div><!-- /.col-md-6 -->
			</div><!-- /.row -->
